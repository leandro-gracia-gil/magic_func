// *** DISCLEAMER ***
//
// The code here has been extracted from:
// http://codereview.stackexchange.com/questions/14730/impossibly-fast-delegate-in-c11
//
// This code is only used for benchmarking purposes as a C++11 implementation of
// the "impossibly fast delegates" article. This code is not part of MagicFunc
// nor its contents have influenced MagicFunc's development or features.
//
// No copyright is claimed over this code in any way, nor it's subject to the
// license of the MagicFunc library. All rights belong to the source's authors.
...
public:
  ...
  // --------------------------------------------------
  // *** This is a fix missing in the original code ***
  // --------------------------------------------------
  ~delegate() {
    if (deleter_ && store_.get())
      deleter_(store_.get());
  }
  // --------------------------------------------------
